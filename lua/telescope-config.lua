...
vim.api.nvim_set_keymap("n", "<leader>fC", ":Telescope git_bcommits<CR>", { noremap = true })
...
vim.api.nvim_set_keymap("n", "<leader>fb", ":Telescope file_browser sorting_strategy=ascending<CR><CR>", { noremap = true })
